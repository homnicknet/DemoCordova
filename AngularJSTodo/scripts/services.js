(function () {
    ...
    angular.module("xPlat.services")
        ...
        .factory("azureStorage", ["$q", "$resource", "$rootScope", "guidGenerator", function ($q, $resource, $rootScope, guidGenerator) {
            ...
            var azureMobileServicesKey = 'NNgcSCZBElfkeyyXdbLkcOPCgSJCWs39'; // Add your Azure Mobile Service Application Key
            var azureMobileServicesAddress = 'https://hsitodo.azure-mobile.net/'; // Add your Azure Mobile Service Application URL
        ...
        .factory("maps", ["$rootScope", "$q", "$window", "$resource", "cordova", function ($rootScope, $q, $window, $resource, cordova) {
            var key = 'AtQpoDsp0G80OsoMKHSgDH8zhbTyHnR9CPZsLTdib2qLtDDXL57JeZlfTybX_GZI'; // Add your Bing Maps API key
